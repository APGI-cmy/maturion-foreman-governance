...
| `foreman-v2.agent.md` | `.github/agents/foreman-v2.agent.md` | `4fd1df10bbff116f456354556f159fe032a0c4829c13188c701a218d62c16b8c` | 2026-04-19 | CodexAdvisor session-013 (v3.0.1: Remove 5 excess canon-ref entries from metadata — was 11 entries, platform limit is 10; fixes "Invalid config: metadata has more than 10 entries" load failure) |
