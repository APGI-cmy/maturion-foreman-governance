...
7. Diff record, PREHANDOVER, session memory, and independent assurance evidence.
...
CodexAdvisor may modify other agents' contracts only under exact CS2 authority and may never modify its own contract. Independent assurance remains separate and blocking outside an explicitly CS2-authorised root bootstrap route; CS2 remains sole merge authority. Before handover confirm checklist and method loading, four phases, authorised paths, size, QP, parity, OPOJD, evidence, and truthful draft PR posture. Completion does not authorise implementation, propagation, activation, or a successor wave.
