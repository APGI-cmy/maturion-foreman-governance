...
**Created**: 2025-12-31
**Last Updated**: 2026-02-16 (Living Agent Operating Model v1.0.0 implementation)
...
| `AGENT_INVOCATION_AND_DELEGATION_PROTOCOL.md` | **NEW v1.0.0 (2026-02-16) PUBLIC_API G-C-AOP-001** - Canonical standard establishing Agent Invocation and Delegation as MANDATORY (not optional). Implements OPOJD accountability model, "if you see it, you own it" doctrine, formal delegation specifications, verification requirements, and accountability chain. Agents MUST invoke/delegate when work exceeds authority boundaries | Readiness, Layer-down, PR-gates, Feedback/learning |
| `AGENT_RIGHTS_BOUNDARIES_AND_DUTIES_REGISTRY.md` | **NEW v1.0.0 (2026-02-16) PUBLIC_API G-C-AOP-002** - Centralized registry codifying explicit rights, boundaries, and duties for each agent type. Defines YOU MAY DO (permissions), YOU MAY NOT DO (prohibitions), YOU MUST DO (mandatory responsibilities), YOU MUST INVOKE WHEN (delegation triggers). Includes complete authority matrix and common delegation patterns. Every agent operates with explicit, testable permissions and constraints | Readiness, Layer-down, PR-gates |
| `AGENT_HANDOVER_AND_QUALITY_PROTOCOL.md` | **NEW v1.0.0 (2026-02-16) PUBLIC_API G-C-AOP-003** - Comprehensive handover and quality protocol implementing three-tier governance prompt structure (Tier 1: Role & General Governance, Tier 2: Agent-Specific Protocol, Tier 3: Pre-Handover & Delivery Protocol). Mandates pre-handover duplicate merge gate runs in workspace, test debt detection/elimination, quality verification checklist, mandatory improvement suggestions, delivery beyond minimum, and pre-handover proof document. Handovers are validated, improved, excellence-driven deliveries | Readiness, Layer-down, PR-gates, Feedback/learning |
| `AGENT_CREATIVE_OWNERSHIP_AND_IMPROVEMENT_DOCTRINE.md` | **NEW v1.0.0 (2026-02-16) PUBLIC_API G-C-AOP-004** - Doctrine establishing creative ownership, proactive improvement, and intelligent accountability as fundamental principles. Agents are intelligent, creative professionals (not mechanical executors) expected to think critically, own problems holistically, continuously elevate quality. Establishes "if you see it, you own it" doctrine, no blame-shifting, deliver beyond minimum, relentless quality focus, problem discovery response protocol, continuous improvement workflow | Readiness, Feedback/learning, PR-gates |
| `AGENT_MERGE_GATE_HANDOVER_ENHANCEMENT.md` | **NEW v1.0.0 (2026-02-16) PUBLIC_API G-C-AOP-005** - Enhanced merge gate requirements detecting/preventing test dodging, technical debt, and quality shortcuts. Comprehensive test debt detection (8 categories: failing, skipped, TODO, commented, excluded, hidden, incomplete fixtures, suppressed warnings, flaky tests), test dodging detection, technical debt detection, warning/deprecation detection, pre-handover duplicate gate runs, evidence-first failure messaging. Merge gates catch ALL quality compromise forms | PR-gates, Readiness, Layer-down |
