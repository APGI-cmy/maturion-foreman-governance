...
| `execution-ceremony-admin-agent.md` | `.github/agents/execution-ceremony-admin-agent.md` | `ef26087ccb4e212a962d5f7d92f30a43f2861739aafab1cbf40a6fc36fb33bc9` | 2026-09-04 | CodexAdvisor-agent / Issue #1394 (canonical PR-scoped administrative-evidence capability and bootstrap identity) |
