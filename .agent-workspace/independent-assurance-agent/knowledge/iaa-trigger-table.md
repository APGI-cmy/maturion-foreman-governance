...
| AGENT_ADMIN_ARTIFACT | YES — MANDATORY | Any `.agent-admin/` file created or modified | Governance-control path; includes prehandover proofs, gate results, assurance tokens, scope declarations, and wave checklists. Aligned with MMM_SIMPLE_PR_ADMIN_MODEL.md v1.2.0. |
