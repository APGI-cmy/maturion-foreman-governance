...
**QA enforcement is governed by the Quality Integrity Contract (QIC).** See [`/foreman/qa/quality-integrity-contract.md`](/foreman/qa/quality-integrity-contract.md) for complete specification.
