...
| `independent-assurance-agent.md` | `.github/agents/independent-assurance-agent.md` | `ed4b301bcdcafc015bd2e61be25920ed7e4eb64d516cadd537e29337bb710642` | 2026-09-04 | CodexAdvisor issue #1399 (canonical wave-record-only Pre-Brief carrier alignment; CS2 direct review required) |
