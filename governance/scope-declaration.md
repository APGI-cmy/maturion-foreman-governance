...
- IAA evidence artifacts: wave checklist, preflight/governance/working proofs, PREHANDOVER proof, rejection packages, session memory files, and this scope declaration — created retroactively per REJECTION-PACKAGE IAA-20260403-PR1317 remediation
...
Manual verification: `git diff --name-only origin/main...HEAD` returns exactly 14 files, matching the FILES_CHANGED list above (line count: 14 == 14).
