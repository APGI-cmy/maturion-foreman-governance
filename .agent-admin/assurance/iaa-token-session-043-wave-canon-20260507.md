...
| Phase 4 — Handover | PASS | Preflight Evidence Gate and Governance Gate PASS at HEAD 345c2ecc; admin-ceremony failure is pre-existing bypass-eligible; iaa/assurance-check resolved by this token |
