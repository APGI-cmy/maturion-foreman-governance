...
- `governance/canon/AGENT_FILE_CREATION_POLICY.md` → `governance/canon/agent-contracts-guidance/AGENT_FILE_CREATION_POLICY.md`
...
- `governance/canon/AGENT_CONTRACT_MIGRATION_GUIDE.md` → `governance/canon/agent-contracts-guidance/AGENT_CONTRACT_MIGRATION_GUIDE.md`
...
- `governance/runbooks/AGENT_FILE_VALIDATION.md` → `governance/canon/agent-contracts-guidance/runbooks/AGENT_FILE_VALIDATION.md`
- `governance/runbooks/AGENT_FILE_MAINTENANCE.md` → `governance/canon/agent-contracts-guidance/runbooks/AGENT_FILE_MAINTENANCE.md`
...
- `governance/canon/agent-contracts-guidance/AGENT_CONTRACT_MIGRATION_GUIDE.md`
