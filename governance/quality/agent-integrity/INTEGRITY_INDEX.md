...
| `execution-ceremony-admin-agent.md` | `.github/agents/execution-ceremony-admin-agent.md` | `b04f02682d6ba65a0b5220bd0a278ff7343f9d4346bbafa592af140fda1c43fe` | 2026-09-04 | CodexAdvisor-agent / Issue #1394 (canonical PR-scoped administrative-evidence capability and bootstrap identity) |
