# FOREMAN REQUIREMENTS CHECKLIST

**Generated**: 2026-02-11  
**Authority**: Governance Canon + FM-Specific Canon  
**Scope**: foreman agent (supervisor class) operating in consumer repositories  
**Version**: 2.0.0 (Derived from FM-specific canon + constitutional canon)

---

## Overview

This checklist defines all requirements for the foreman agent, derived exclusively from:
...
**Statement**: MUST create session memory in `.agent-workspace/foreman/memory/` with structured format per LIVING_AGENT_SYSTEM.md.  
...
**Severity**: LOW  
**Validation Hook**: `ls -1 .agent-workspace/foreman/memory/session-*.md | wc -l` should be ≤ 5
...
**Source**: `governance/canon/SELF_ALIGNMENT_AUTHORITY_MODEL.md` Section 4.2  
**Severity**: CRITICAL  
**Validation Hook**: Escalation document in `.agent-workspace/foreman/escalation-inbox/` or CS2 approval in PR
