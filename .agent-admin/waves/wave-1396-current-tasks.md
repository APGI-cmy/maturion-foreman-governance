# Wave 1396 - Minimal Canonical ECAP Foundation - Task Checklist

**Wave**: 1396
**Governing issue**: #1396
**Foreman**: foreman-v2-agent
**Status**: PRE-BRIEF PENDING
**Scope authority**: CS2 direction of 2026-09-04

This checklist applies only to the replacement foundation described in issue #1396.
Closed PR #1395 and its evidence are historical context and are not active proof.
