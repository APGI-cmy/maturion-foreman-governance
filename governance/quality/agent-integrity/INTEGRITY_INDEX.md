...
| `foreman-v2.agent.md` | `.github/agents/foreman-v2.agent.md` | `2b9e190be58f160397da6c4a3013157668e978b09b78f615fffb4eb5fa07b804` | 2026-04-09 | Copilot (v2.4.0 fix — §4.5 stop-and-fix loop: step 3 corrected to use fresh PREHANDOVER proof per round; no editing of committed proofs per §4.3b; step 7 added for token recording) |
