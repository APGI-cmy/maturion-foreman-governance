...
### 4.3b Token Update Ceremony (FM_H — MANDATORY after IAA PASS)
...
4. The submitting agent (Foreman) commits the token file as a **new file only** —
...
5. If the IAA issues a REJECTION-PACKAGE, it similarly writes a new rejection artifact;
   the Foreman opens a STOP-AND-FIX, fixes the gaps, and re-initiates handover
