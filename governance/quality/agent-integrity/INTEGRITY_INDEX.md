...
| `foreman-v2.agent.md` | `.github/agents/foreman-v2.agent.md` | `954db1d2cd202ce2565d9ebb8bc17b8b2dd347465afd3e4e027b2ffc2144771b` | 2026-04-08 | Copilot (v2.4.0 — §4.5 REJECTION-PACKAGE handler expanded with Foreman-owned stop-and-fix loop REQ-REINVOKE-001 and prohibited wording rule; IAA_PRE_BRIEF_PROTOCOL.md reference v1.2.0→v1.2.2; authority: CS2 — Foreman IAA re-invocation ownership canonisation issue) |
